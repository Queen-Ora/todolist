package com.example.oratodolist.ui.views.screens.authentication
...
import com.example.oratodolist.R
import com.example.oratodolist.todolist.data.room.models.User
import com.example.oratodolist.ui.components.DefaultCheckBox
import com.example.oratodolist.ui.components.DefaultTextField
import com.example.oratodolist.ui.theme.OraTodoListTheme
import com.example.oratodolist.ui.views.screens.AuthRouteScreens
import com.example.oratodolist.ui.views.layout.BackTopAppBar
import com.example.oratodolist.utils.StringConstants
import com.example.oratodolist.utils.emailLengthValidation
import com.example.oratodolist.utils.fullNameLengthValidation
import com.example.oratodolist.utils.passwordLengthValidation
import com.example.oratodolist.viewmodels.AuthViewModel
                ...
                Column(
                    ...
                    Column (
                        ...
                        Button(
                                        ...
                                        if (!isTermsAccepted){
                                            ...
                                            if (authState.usersList.isNotEmpty()) {
                                                ...
                                                authViewModel.sendOTPCode(
                                                    com.example.oratodolist.todolist.data.room.models.OTPCode(
                                                        email = email,
                            ...
                            Text(text = if (isLoading) stringResource(id = R.string.loading) else stringResource(id = R.string.register))
                        }
