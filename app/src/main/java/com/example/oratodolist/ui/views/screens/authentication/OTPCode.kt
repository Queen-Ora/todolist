...
import com.example.oratodolist.ui.views.screens.MainRouteScreens
import com.example.oratodolist.ui.views.screens.StartRouteScreens
    ...
    OraTodoListTheme {
        Scaffold(
            ...
            Column(
                ...
                Column (
                    verticalArrangement = Arrangement.spacedBy(space = dimensionResource(id = R.dimen.size_4)),
                    modifier = Modifier
                    ...
                    Button(
                        onClick = {
                            ...
                            scope.launch {
                                ...
                                if (authState.otpCodes.isNotEmpty()) {
                                    isCodeError = true
